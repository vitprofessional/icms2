                        ...
                        <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarLayouts">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('cashCalculasView')}}" class="nav-link" data-key="t-horizontal">Debit/Credit</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('reportListView')}}"  class="nav-link" data-key="t-detached">Get Report</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                                ...
                                <div class="collapse menu-dropdown mega-dropdown-menu" id="sidebarUI">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="{{route('configurationEdit')}}" class="nav-link" data-key="t-config">Configuration</a>
                                                </li>
                                                <li class="nav-item">
