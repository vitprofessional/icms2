...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <header>
            <!-- start navigation -->
            <nav class="navbar navbar-default bootsnav navbar-top header-dark background-transparent nav-box-width white-link navbar-expand-lg">
        ...
        <section id="home" class="parallax p-0 mobile-height wow animate__fadeIn" data-parallax-background-ratio="0.5" style="background-image:url('https://via.placeholder.com/1920x1200');">
            <div class="opacity-full bg-extra-dark-gray"></div>
            <div class="container position-relative full-screen">
                <div class="row h-100 align-items-center">
                    <div class="col-12 text-center">
                        <div class="bg-black-opacity-light w-50 mx-auto md-w-80 xs-w-95">
                            <div class="padding-fifteen-all sm-padding-twelve-all xs-padding-25px-all">
                                ...
                                <span class="text-medium-gray w-60 d-block mx-auto text-large md-w-100">The page you were looking for could not be found.</span>
                                <form action="search-result.html" method="post" class="position-relative">
                                    <div class="input-group-404 input-group margin-50px-tb sm-margin-20px-tb">
                                        ...
                                        <div class="input-group-append">
                                            <button type="submit" class="btn btn-large bg-white text-medium-gray search-button"><i class="ti-search icon-small m-0 position-raltive top-2"></i></button>
                                        </div>
                                    </div>
                                </form>
                                <a href="index.html" class="btn btn-transparent-white btn-medium text-extra-small border-radius-4"><i class="ti-arrow-left margin-5px-right ms-0" aria-hidden="true"></i> Back To Homepage</a>
                            </div>                       
                        </div>
                    </div>
                </div>
