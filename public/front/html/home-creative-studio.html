...
<html class="no-js" lang="en">
    ...
    <body class="left-nav-sidebar">
        ...
        <header>
            <div class="left-nav">
                ...
                <div class="sidebar-part1">
                    <a href="index.html" title="Pofo" class="logo"><img src="images/logo-icon-fill.png" data-at2x="images/logo-icon-fill@2x.png" alt="Pofo"></a> 
                </div>
                <!-- end logo -->
                                    ...
                                    <ul class="nav navbar-nav margin-80px-bottom">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu second-level">
                                                <li class="dropdown">
                                                    <a href="#" title="Home" data-bs-toggle="dropdown">Classic <i class="fa-solid fa-angle-right"></i></a>
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Home" data-bs-toggle="dropdown">Creative <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Home" data-bs-toggle="dropdown">Portfolio <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Home" data-bs-toggle="dropdown">Blog <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                        ...
                                        <li class="dropdown">
                                            <a data-bs-toggle="dropdown" href="#" title="Pages">Pages <i class="fa-solid fa-angle-right"></i></a>
                                            <ul class="dropdown-menu second-level">
                                                <li class="dropdown">
                                                    <a href="#" title="About" data-bs-toggle="dropdown">About <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Services" data-bs-toggle="dropdown">Services <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Contact" data-bs-toggle="dropdown">Contact <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Team" data-bs-toggle="dropdown">Team <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Additional" data-bs-toggle="dropdown">Additional <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                        ...
                                        <li class="dropdown">
                                            <a data-bs-toggle="dropdown" href="#" title="Portfolio">Portfolio <i class="fa-solid fa-angle-right"></i></a>
                                            <ul class="dropdown-menu second-level">
                                                <li class="dropdown">
                                                    <a href="#" title="Grid - Full width Layouts" data-bs-toggle="dropdown">Grid - Full Width Layouts <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Masonry  - Full width Layouts" data-bs-toggle="dropdown">Masonry  - Full Width Layouts <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Metro - Full width Layouts" data-bs-toggle="dropdown">Metro - Full Width Layouts <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Other - Full width Layouts" data-bs-toggle="dropdown">Other - Full Width Layouts <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Grid - Boxed Layouts" data-bs-toggle="dropdown">Grid - Boxed Layouts <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Masonry - Boxed Layouts" data-bs-toggle="dropdown">Masonry - Boxed Layouts <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Metro - Boxed Layouts" data-bs-toggle="dropdown">Metro - Boxed Layouts <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Other - Boxed Layouts" data-bs-toggle="dropdown">Other - Boxed Layouts <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Single Project Page" data-bs-toggle="dropdown">Single Project Page <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Portfolio Columns" data-bs-toggle="dropdown">Portfolio Columns <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                        ...
                                        <li class="dropdown">
                                            <a data-bs-toggle="dropdown" href="#" title="Blog">Blog <i class="fa-solid fa-angle-right"></i></a>
                                            <ul class="dropdown-menu second-level">
                                        ...
                                        <li class="dropdown">
                                            <a data-bs-toggle="dropdown" href="#" title="Contact">Elements <i class="fa-solid fa-angle-right"></i></a>
                                            <ul class="dropdown-menu second-level">
                                                <li class="dropdown">
                                                    <a href="#" title="General elements" data-bs-toggle="dropdown">General Elements <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Infographics / icons" data-bs-toggle="dropdown">Infographics / Icons <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Interactive Elements" data-bs-toggle="dropdown">Interactive Elements <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Text & containers" data-bs-toggle="dropdown">Text & Containers <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                        ...
                                        <li class="dropdown">
                                            <a data-bs-toggle="dropdown" href="#" title="Features">Features <i class="fa-solid fa-angle-right"></i></a>
                                            <ul class="dropdown-menu second-level">
                                                <li class="dropdown">
                                                    <a href="#" title="Header Styles" data-bs-toggle="dropdown">Header Styles <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Footer" data-bs-toggle="dropdown">Footer <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Page Title" data-bs-toggle="dropdown">Page Title <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                                                ...
                                                <li class="dropdown">
                                                    <a href="#" title="Single image lightbox" data-bs-toggle="dropdown">Single Image Lightbox <i class="fa-solid fa-angle-right"></i></a>
                                                    <ul class="dropdown-menu third-level">
                    ...
                    <div id="rev_slider_151_1" class="rev_slider fullscreenbanner" data-version="5.4.1">
                        <ul>
                            ...
                            <li data-index="rs-411" data-transition="fadethroughtransparent" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/blur1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="One" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                <!-- main image -->
                                <img src="https://via.placeholder.com/1920x982"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="6" class="rev-slidebg" data-no-retina>
                                <!-- layers -->
                                                ...
                                                <div class="tp-caption" 
                                                    ...
                                                    <div class="tp-caption " 
                                                        ...
                                                        <div class="tp-caption blurslider-gradient alt-font font-weight-600 title-extra-large margin-30px-bottom" 
                                                             ...
                                                             style="z-index: 11; letter-spacing: -1px;"><a href="single-project-page-01.html" class="text-white-2 text-white-2-hover">Midnight<br>Studio</a></div>
                            ...
                            <li data-index="rs-412" data-transition="fadethroughtransparent" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/blurbg14-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Two" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                <!-- main image -->
                                <img src="https://via.placeholder.com/1920x1080"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="6" class="rev-slidebg" data-no-retina>
                                <!-- layers -->
                                                ...
                                                <div class="tp-caption  " 
                                                    ...
                                                    <div class="tp-caption  " 
                                                        ...
                                                        <div class="tp-caption blurslider-gradient alt-font text-white-2 font-weight-600 title-extra-large margin-30px-bottom" 
                                                             ...
                                                             style="z-index: 11; letter-spacing: -1px;"><a href="single-project-page-02.html" class="text-white-2 text-white-2-hover">Branding<br>Experience</a></div>
                            ...
                            <li data-index="rs-413" data-transition="fadethroughtransparent" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/blurbg10-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Three" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                <!-- main image -->
                                <img src="https://via.placeholder.com/1920x1254"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="6" class="rev-slidebg" data-no-retina>
                                <!-- layers -->
                                <div class="opacity-extra-medium bg-black"></div>
                                                ...
                                                <div class="tp-caption  " 
                                                    ...
                                                    <div class="tp-caption  " 
                                                        ...
                                                        <div class="tp-caption blurslider-gradient alt-font text-white-2 font-weight-600 title-extra-large margin-30px-bottom" 
                                                             ...
                                                             style="z-index: 11; letter-spacing: -1px;"><a href="single-project-page-03.html" class="text-white-2 text-white-2-hover">Saverio<br>Rescigno</a></div>
                        ...
                        <div style="" class="tp-static-layers">
                            ...
                            <div class="tp-caption   tp-static-layer" 
                                 ...
                                 style="z-index: 17; min-width: 260px; max-width: 260px; white-space: nowrap; font-size: 15px; line-height: 15px; font-weight: 500; color: rgba(255, 255, 255, 1.00);">1 <div class="blurslider-line" style="display:inline-block;width:40px;height:1px;background:#ff214f;margin: 10px 20px 4px 15px;"></div>Design</div>
                            ...
                            <div class="tp-caption   tp-static-layer" 
                                 ...
                                 style="z-index: 20; min-width: 260px; max-width: 260px; white-space: nowrap; font-size: 15px; line-height: 15px; font-weight: 500; color: rgba(255, 255, 255, 1.00);">2 <div class="blurslider-line" style="display:inline-block;width:40px;height:1px;background:#ff214f;margin: 10px 20px 4px 15px;"></div>Branding</div>
                            ...
                            <div class="tp-caption   tp-static-layer" 
                                 ...
                                 style="z-index: 23; min-width: 260px; max-width: 260px; white-space: nowrap; font-size: 15px; line-height: 15px; font-weight: 500; color: rgba(255, 255, 255, 1.00);">3 <div class="blurslider-line" style="display:inline-block;width:40px;height:1px;background:#ff214f;margin: 10px 20px 4px 15px;"></div>Marketing</div>
            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-2 row-cols-sm-2 justify-content-center">
                    ...
                    <div class="col text-center feature-box-11 position-relative md-margin-eight-bottom sm-margin-ten-bottom wow animate__fadeInRight last-paragraph-no-margin">
                        ...
                        <div class="alt-font margin-30px-top margin-5px-bottom text-extra-dark-gray font-weight-600">Discussion of the Idea</div>
                    ...
                    <div class="col text-center feature-box-11 position-relative md-margin-eight-bottom sm-margin-ten-bottom wow animate__fadeInRight last-paragraph-no-margin" data-wow-delay="0.4s">
                        ...
                        <div class="alt-font margin-30px-top margin-5px-bottom text-extra-dark-gray font-weight-600">Handcrafted Templates</div>
                        <p class="w-75 lg-w-95 md-w-80 mx-auto">Lorem Ipsum is simply text of the printing and typesetting standard industry.</p>
                    </div>
                    <!-- end process step item -->
                    <!-- start process step item -->
                    <div class="col text-center feature-box-11 position-relative xs-margin-ten-bottom wow animate__fadeInRight last-paragraph-no-margin" data-wow-delay="0.8s">
                        ...
                        <div class="alt-font margin-30px-top margin-5px-bottom text-extra-dark-gray font-weight-600">Testing for Perfection</div>
                        <p class="w-75 lg-w-95 md-w-80 mx-auto">Lorem Ipsum is simply text of the printing and typesetting standard industry.</p>
                    </div>
                    <!-- end process step item -->
                    <!-- start process step item -->
        ...
        <section class="wow animate__fadeIn p-0">
            <div class="swiper-auto-height-container swiper position-relative" data-slider-options='{ "loop": true, "effect":"fade", "autoHeight":true, "allowTouchMove":true, "autoplay": { "delay": 3000 }, "navigation": { "nextEl": ".swiper-button-next", "prevEl": ".swiper-button-prev" }, "pagination": { "el":".swiper-pagination-01", "clickable": true } }'>
                <div class="swiper-wrapper">
                    <!-- start slider item -->
                    <div class="swiper-slide padding-100px-all sm-padding-20px-all cover-background" style="background-image:url(https://via.placeholder.com/1920x1100)">
                        <div class="position-relative w-40 xl-w-45 lg-w-60 md-w-85 sm-w-100 d-inline-block slide-banner last-paragraph-no-margin">
                            <div class="padding-80px-all lg-padding-65px-all md-padding-40px-all sm-w-100 bg-black-opacity sm-padding-fifteen-tb sm-padding-30px-all text-center text-md-start">
                                <h5 class="alt-font text-white-2 w-90 md-w-100">A digital studio crafting beautiful experiences.</h5>
                    ...
                    <!-- end slider item -->
                    <!-- start slider item -->
                    <div class="swiper-slide padding-100px-all sm-padding-20px-all cover-background" style="background-image:url(https://via.placeholder.com/1920x1697)">
                        <div class="position-relative w-40 xl-w-45 lg-w-60 md-w-85 sm-w-100 d-inline-block slide-banner last-paragraph-no-margin"> 
                            <div class="padding-80px-all lg-padding-65px-all md-padding-40px-all bg-black-opacity sm-padding-fifteen-tb sm-padding-30px-all text-center text-md-start">
                                <h5 class="alt-font text-white-2 w-90 md-w-100">We always stay on the cutting edge of digital</h5>
                                <p class="w-90 lg-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                <a href="javascript:void(0);" class="margin-35px-top md-margin-15px-top btn btn-small btn-white">Explore services</a>
                            </div>  
                        </div>
                    ...
                    <!-- end slider item -->
                    <!-- start slider item -->
                    <div class="swiper-slide padding-100px-all sm-padding-20px-all cover-background" style="background-image:url(https://via.placeholder.com/1920x1526)">
                        <div class="position-relative w-40 xl-w-45 lg-w-60 md-w-85 sm-w-100 d-inline-block slide-banner last-paragraph-no-margin">
                            <div class="padding-80px-all lg-padding-65px-all md-padding-40px-all bg-black-opacity sm-padding-fifteen-tb sm-padding-30px-all text-center text-md-start">
                                <h5 class="alt-font text-white-2 w-90 md-w-100">We combine design, thinking and technical.</h5>
                                <p class="w-90 lg-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                <a href="javascript:void(0);" class="margin-35px-top md-margin-15px-top btn btn-small btn-white">Explore services</a>
                            </div>     
                        </div>
                ...
                <div class="navigation-area">
                    <div class="swiper-button-next swiper-next-style4"><i class="fa-solid fa-arrow-up" aria-hidden="true"></i></div>
                    <div class="swiper-button-prev swiper-prev-style4"><i class="fa-solid fa-arrow-down" aria-hidden="true"></i></div>
                </div>
        ...
        <section class="wow animate__fadeIn bg-light-gray"> 
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-center text-lg-start md-margin-five-bottom sm-margin-ten-bottom last-paragraph-no-margin">
                        <span class="text-extra-large text-extra-dark-gray alt-font margin-15px-bottom d-block w-85 lg-w-100">We combine design and thinking and technical craft.</span>
                    ...
                    <div class="col-lg-8">
                        <div class="row row-cols-1 row-cols-md-4 row-cols-sm-2 align-items-center">
                            ...
                            <div class="col text-center sm-margin-30px-bottom wow animate__zoomIn">
                                <img src="images/image-icon1.png" alt=""><p class="alt-font margin-10px-top mb-0">Branding</p>
                            </div>
                            <!-- end features box item -->
                            <!-- start features box item -->
                            <div class="col text-center sm-margin-30px-bottom wow animate__zoomIn" data-wow-delay="0.2s">
                                <img src="images/image-icon2.png" alt=""><p class="alt-font margin-10px-top mb-0">Innovation</p>
                            </div>
                            <!-- end features box item -->
                            <!-- start features box item -->
                            <div class="col text-center xs-margin-30px-bottom wow animate__zoomIn" data-wow-delay="0.4s">
                                <img src="images/image-icon3.png" alt=""><p class="alt-font margin-10px-top mb-0">Technology</p>
                            </div>
                            <!-- end features box item -->
                            <!-- start features box item -->
                            <div class="col text-center wow animate__zoomIn" data-wow-delay="0.6s">
                                <img src="images/image-icon4.png" alt=""><p class="alt-font margin-10px-top mb-0">Superiority</p>
                            </div>
                            <!-- end features box item -->
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center margin-100px-bottom md-margin-70px-bottom sm-margin-50px-bottom">
                        ...
                        <h5 class="text-uppercase alt-font text-extra-dark-gray margin-20px-bottom font-weight-700 md-w-100">New Projects</h5>
                        ...
                        <ul class="hover-option2 portfolio-wrapper grid grid-loading grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-small">
                            ...
                            <li class="grid-item wow animate__fadeInUp">
                                <a href="single-project-page-01.html">
                                    <figure>
                                        <div class="portfolio-img bg-deep-pink"><img src="https://via.placeholder.com/800x560" alt="" data-no-retina /></div>
                                        <figcaption>
                            ...
                            <li class="grid-item wow animate__fadeInUp" data-wow-delay="0.2s">
                                <a href="single-project-page-01.html">
                                    <figure>
                                        <div class="portfolio-img bg-deep-pink"><img src="https://via.placeholder.com/800x1140" alt=""/></div>
                                        <figcaption>
                                            <div class="portfolio-hover-main text-start">
                                                <div class="portfolio-hover-box align-bottom">
                                                    <div class="portfolio-hover-content position-relative last-paragraph-no-margin">
                            ...
                            <li class="grid-item wow animate__fadeInUp" data-wow-delay="0.4s">
                                <a href="single-project-page-01.html">
                                    <figure>
                                        <div class="portfolio-img bg-deep-pink"><img src="https://via.placeholder.com/800x560" alt=""/></div>
                                        <figcaption>
                                            <div class="portfolio-hover-main text-start">
                                                <div class="portfolio-hover-box align-bottom">
                                                    <div class="portfolio-hover-content position-relative last-paragraph-no-margin">
        ...
        <section class="wow animate__fadeIn parallax" data-parallax-background-ratio="0.4" style="background-image:url('https://via.placeholder.com/1920x1200');">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 lg-margin-15px-top md-no-margin-top md-margin-ten-bottom sm-padding-five-lr sm-margin-ten-bottom wow animate__fadeIn last-paragraph-no-margin">
                        <div class="padding-fourteen-right md-no-padding-right text-center text-lg-start">
                            <h5 class="alt-font text-white-2">A digital studio crafting beautiful experiences.</h5>
                    ...
                    <!-- end feature box item -->
                    <!-- start feature box item -->
                    <div class="col-lg-3 col-sm-6 position-relative text-center xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=sU3FkzUKHXU">
                            <img src="https://via.placeholder.com/800x1022" alt="" class="w-100">
                            <div class="icon-play">
                    ...
                    <!-- end feature box item -->
                    <!-- start feature box item -->
                    <div class="col-lg-3 col-sm-6 position-relative text-center wow animate__fadeIn" data-wow-delay="0.4s">
                        <img src="https://via.placeholder.com/800x1022" alt="" class="w-100">
                    </div>
                    <!-- end feature box item -->
                </div>
        ...
        <section class="wow animate__fadeIn" style="background-image: url('https://via.placeholder.com/1920x1096')">
            <div class="container"> 
                <div class="row position-relative">
                    <div class="swiper-pagination-bottom swiper black-move testimonial-style2 text-center padding-35px-bottom lg-padding-20px-bottom sm-padding-10px-bottom wow animate__fadeIn" data-slider-options='{ "slidesPerView": "1", "allowTouchMove":true, "loop": true, "autoplay": { "delay": 3000, "disableOnInteraction": false }, "keyboard": { "enabled": true, "onlyInViewport": true }, "navigation": { "nextEl": ".swiper-button-next-02", "prevEl": ".swiper-button-prev-02" }, "pagination": { "el": ".swiper-pagination-02", "clickable": true } }'>
                        <div class="swiper-wrapper">
                            <!-- start testimonial item -->
                            <div class="swiper-slide">
                                <div class="row justify-content-center m-0">
                                    <div class="col-xl-7 col-lg-8 col-md-10">
                                        <div class="testimonia-block w-90 sm-w-100 mx-auto">
                                            ...
                                            <div class="profile-box">
                                                <img src="https://via.placeholder.com/300x300" alt="" class="w-20 rounded-circle border-color-white border-width-4 border-all margin-15px-bottom sm-no-margin-bottom">
                        ...
                        <!--<div class="swiper-button-next text-black swiper-button-next-02 arrow-light"><i class="ti-arrow-right icon-small"></i></div>
                        <div class="swiper-button-prev text-black swiper-button-prev-02 arrow-light"><i class="ti-arrow-left icon-small"></i></div>-->
                        <!-- end slider pagination -->
        ...
        <section class="wow animate__fadeIn">
            <div class="container text-center">
                <div class="swiper black-move" data-slider-options='{ "slidesPerView": "1", "loop":true, "allowTouchMove":true, "autoplay": { "delay": 3000, "disableOnInteraction": false}, "keyboard": { "enabled": true, "onlyInViewport": true }, "navigation": { "nextEl": ".swiper-button-next", "prevEl": ".swiper-button-prev" }, "pagination": { "el": ".swiper-pagination-03", "clickable": true }, "breakpoints": { "1200":{ "slidesPerView":"4" }, "992": { "slidesPerView":"3" }, "768": { "slidesPerView":"3" } } }'>
                    <div class="swiper-wrapper">
                        <!-- start client slider item --><div class="swiper-slide text-center"><img src="images/logo-1.png" alt=""></div><!-- end client slider item -->
                        <!-- start client slider item --><div class="swiper-slide text-center"><img src="images/logo-2.png" alt=""></div><!-- end client slider item -->
                        <!-- start client slider item --><div class="swiper-slide text-center"><img src="images/logo-3.png" alt=""></div><!-- end client slider item -->
                        <!-- start client slider item --><div class="swiper-slide text-center"><img src="images/logo-4.png" alt=""></div><!-- end client slider item -->
                        <!-- start client slider item --><div class="swiper-slide text-center"><img src="images/logo-5.png" alt=""></div><!-- end client slider item -->
                        <!-- start client slider item --><div class="swiper-slide text-center"><img src="images/logo-6.png" alt=""></div><!-- end client slider item -->
                        <!-- start client slider item --><div class="swiper-slide text-center"><img src="images/logo-7.png" alt=""></div><!-- end client slider item -->
                        <!-- start client slider item --><div class="swiper-slide text-center"><img src="images/logo-8.png" alt=""></div><!-- end client slider item -->
                    </div>
